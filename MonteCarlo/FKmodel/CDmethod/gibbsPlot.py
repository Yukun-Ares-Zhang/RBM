...
The code plots the sampling distribution and the target in a same figure
"""
...
for start_k in [10]:
    for sample_interval in [1,5,10]:
        ...
        ax.set_yscale("log")
        ax.set_title("Target prob distribution")
        ax.set_xlabel("config num")
        ax.set_ylabel("count")
        fig.savefig("figs/gibbs/show.png")
        break
