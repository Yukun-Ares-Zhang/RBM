...
if __name__=='__main__':
    ...
    for lr in [0.1, 0.01, 0.001]:
        for n_iteration in [100, 1000, 10000]:    
            ...
            with open("./energy_lr"+str(lr)+"_n"+str(n_iteration)+".txt", "w") as f1:
                print("Pred\tExac", file = f1)
                for i in range(Test_erg.shape[0]):
                    print("%5.2f\t%5.2f"%(Predict_erg[i], Test_erg[i]),file = f1)
            
            print("print energy done!")    
            
            np.savetxt("weights_lr"+str(lr)+"_n"+str(n_iteration)+".txt", rbm.components_, fmt="%5.6f", delimiter="\t")
            np.savetxt("intercept_hidden_lr"+str(lr)+"_n"+str(n_iteration)+".txt", rbm.intercept_hidden_, fmt="%5.6f", delimiter="\t")
            np.savetxt("intercept_visible_lr"+str(lr)+"_n"+str(n_iteration)+".txt", rbm.intercept_visible_, fmt="%5.6f", delimiter="\t")